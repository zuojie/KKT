...
from src.Mall import *

# 信息机器人服务类，定期Run一次
class MainServiceMall(win32serviceutil.ServiceFramework):
	_svc_name_ = "MainServiceMall" 
	_svc_display_name_ = "MainService-Mall" 
	...
	def SvcDoRun(self): 
		...
		self.timeout = 3 * 60 * 60 * 1000 # 3 hours per round
		fetioner = CMallMain()
		while 1:
			#定时器，像监听器
...
if __name__=='__main__': 
	win32serviceutil.HandleCommandLine(MainServiceMall)