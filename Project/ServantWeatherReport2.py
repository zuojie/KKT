...
from src.WeatherReport2 import *

# 信息机器人服务类，定期Run一次
class MainServiceWeaherReport2(win32serviceutil.ServiceFramework):
	_svc_name_ = "MainServiceWeaherReport2" 
	_svc_display_name_ = "MainService-WeatherReport2" 
...
#	win32serviceutil.HandleCommandLine(MainServiceWeaherReport2)