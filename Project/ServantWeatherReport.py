...
# 信息机器人服务类，定期Run一次
class MainServiceWeaherReport(win32serviceutil.ServiceFramework):
	_svc_name_ = "MainServiceWeaherReport" 
...
if __name__=='__main__': 
	win32serviceutil.HandleCommandLine(MainServiceWeaherReport)